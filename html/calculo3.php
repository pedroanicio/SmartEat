...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE user SET metaPeso = '$metaPeso' WHERE email = '$logado'";

        if ($conexao->query($query) == TRUE) {
            echo "Meta salva com sucesso!";
            header('Location: calculo4.php');
        } else {
...
<main class="full-height">
    ...
    <div class="container pagination">
        <div class="row mt-16">
            <div class="col-12 d-flex flex-row justify-content-center">
                ...
                <a class="nav-link" href="calculo2.php">
    ...
    <form name="formObjetivo" method="post" action="calculo3.php">
        <div class="container register-form">
            ...
            <div class="c-toggle d-inline-block mt-32">            
                <div class="input-label-wrapper mt-4">
                    <input type="telxt" name="update" value="" required>
